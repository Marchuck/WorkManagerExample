...
data class OfflineProtocol(@PrimaryKey(autoGenerate = false) @ColumnInfo(name = "id") var id: Long?,
                           @ColumnInfo(name = "protocol_id") var protocol_id: Long? = null,
                           @ColumnInfo(name = "user_token") var user_token: String= "ewoifncojwncocnoacao",
